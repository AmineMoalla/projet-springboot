...
public List<Etudiant> getEtudiantsByFormateur(@PathVariable Long formateurId) {
return etudiantService.getEtudiantsByFormateur(formateurId);
}
// GET /api/etudiants/{id}/cours
    @GetMapping("/{id}/cours")
    public ResponseEntity<List<Cours>> getCoursByEtudiant(@PathVariable Long id) {
        List<Cours> cours = etudiantService.getCoursByEtudiant(id);
